...
RSpec.feature 'User show page', type: :feature do
  before :each do
    ...
    Post.create(author: @user, title: 'Hi people', text: 'Lorem h', commentscounter: 0, likescounter: 0)
    Post.create(author: @user, title: 'Good', text: 'Consectetur', commentscounter: 0, likescounter: 0)
    Post.create(author: @user, title: 'Dev', text: 'Sed do eiusmod ', commentscounter: 0, likescounter: 0)
  end
  ...
  scenario 'can view a user\'s post' do
    post = Post.create(author: @user, title: 'His', text: 'Lorem', commentscounter: 0, likescounter: 0)
